...
Hao Liu is a second year Ph.D student in the [Accelerated Connected Computing Lab](https://accl.kaust.edu.sa/) (ACCL) at KAUST. He mainly works on accelerating DNN co-inference across multiple devices from edge to cloud. He also works on split computing, reconfigurable computing systems, and has explored machine learning model compression and physically unclonable functions. 
